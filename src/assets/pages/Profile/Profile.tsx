...
export const Profile = () => {
  ...
  return (
    <>
      <div
        className={`flex bg-[#000] w-full h-screen items-center justify-center bg-opacity-50 absolute z-50 ${
          popUpState ? "hidden" : ""
        }`}
      >
        ...
        <div className="w-full h-screen p-[40px] bg-[#e6e6e6]">
          ...
          <div className="flex gap-[18px] items-center">
            <img
              ...
              alt="Profile"
              className="w-[95px] lg:hidden h-[95px] rounded-[282px] object-cover"
            />
            <svg
              width={37}
              height={37}
          ...
          <div className="flex gap-[13px] justify-end items-center">
            <input
              className="w-[490px] hidden lg:block h-[53px] rounded-[220px] bg-white/[0.63] text-xl pl-[32px] text-[#676767]"
          ...
          <div className="lg:mt-[54px] mt-[10px] lg:flex flex-row gap-[7px]">
            {/* left main section */}
            <div className="p-[22px] rounded-[40px] bg-white lg:w-[80%] w-full">
              <div className="flex gap-[150px] justify-between">
                <div className="w-[50%]">
                  <div className="flex items-center gap-[28px]">
                    <div className="">
                      <img
                        src={require(`../../images/ProfilePic.png`)}
                        alt="Profile"
                        className="w-[95px] lg:block hidden h-[95px] rounded-[282px] object-cover"
                      />
                    </div>
                  ...
                  <div className="w-[499px] h-[245px] lg:ml-[70px] lg:mt-[50px]">
                    <img
                      className="w-full h-full object-cover pt-10"
                      src={require(`../../images/grafo.png`)}
                      alt=""
                    />
                  </div>
                </div>
                <div className="lg:flex lg:flex-col hidden gap-[5px] mt-[60px]">
                  <div
              ...
              <div className="lg:mt-[40px] lg:ml-[70px] flex flex-col w-fit gap-[13px]">
                <div className="flex flex-col gap-[5px]">
                  <p className="text-xs text-left text-black">
                    Патничко осигурување
                  </p>
                  <div className="lg:w-[727px] w-[60%] h-[31px] relative">
                    <div className="lg:w-[100%] w-[167%] h-[31px] rounded-[10px] border border-[#b8b8b8] absolute left-[100px]" />
                    <div className="lg:w-[601.56px] w-[70%] h-[31px] rounded-[10px] bg-[#b8b8b8] z-10 relative" />
                  </div>
                </div>
                <div className="flex flex-col gap-[5px]">
                  <p className="text-xs text-left text-black">
                    Велосипедско осигурување
                  </p>
                  <div className="lg:w-[727px] w-[100%] h-[31px] relative">
                    <div className="w-[100%] h-[31px] rounded-[10px] border border-[#b8b8b8] absolute left-[100px]" />
                    <div className="w-[436.2px] h-[31px] rounded-[10px] bg-[#01a180] z-10 relative" />
                  </div>
                </div>
                <div className="flex flex-col gap-[5px]">
                  <p className="text-xs text-left text-black">
                  ...
                  <div className="lg:w-[727px] w-[100%] h-[31px] relative">
                    <div className="w-[100%] h-[31px] rounded-[10px] border border-[#b8b8b8] absolute left-[100px]" />
                    <div className="lg:w-[508.9px] w-[60%] h-[31px] rounded-[10px] bg-[#55d1b9]  z-10 relative" />
                  </div>
                </div>
              </div>
            </div>
